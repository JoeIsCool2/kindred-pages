...
- `GET /api/health`: reports whether admin auth, checkout, publish database, access control, media storage, invite delivery, and support email integrations are configured.
